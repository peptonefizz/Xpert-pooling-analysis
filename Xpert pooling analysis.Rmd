...
ggsave(here("Output","figure_test.pdf"),width = 20, height = 10, units = "cm")
...
ggsave(here("Output","figure_test_distribution.pdf"),width = 20, height = 15, units = "cm")
