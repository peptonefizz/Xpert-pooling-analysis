...
ggsave(here("Output","figure2_test.pdf"),width = 10, height = 10, units = "cm",dpi = 300)
...
ggsave(here("Output","figure3_test_distribution.pdf"),width = 15, height = 15, units = "cm", dpi = 300)
...
ggsave(here("Output","figure4_result_model.pdf"),width = 20, height = 15, units = "cm", dpi = 300)
```
